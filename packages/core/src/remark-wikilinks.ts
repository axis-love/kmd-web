// @axis-love/core — wikilink remark plugin
//
// Transforms [[wikilink]] syntax into markdown link nodes.
// Supports [[target]], [[target|label]], [[path/to/page]], [[page#section]].
//
// This is an internal remark (mdast) plugin — not re-exported.
...
function replaceTextChild(parent: Parent, index: number, node: Text): number | undefined {
